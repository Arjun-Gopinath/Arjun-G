...
$name = $email = $gender = $address = $phone = $fan = "";
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
  ...
  <input type="radio" name="help" <?php if (isset($help) && $help=="wfh") echo "checked";?> value="wfh">Very
  <input type="radio" name="help" <?php if (isset($help) && $help=="phy") echo "checked";?> value="phy">Not much
